    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.ten') }}"><button class="btn {{ request()->is('studentlist/manage/ten') ? 'active-item':'' }}">Ten</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Ten</button></h6>
                </div>
