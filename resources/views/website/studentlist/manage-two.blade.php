    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.two') }}"><button class="btn  {{ request()->is('studentlist/manage/two') ? 'active-item':'' }}">Two</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Two</button></h6>
                </div>
