    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.three') }}"><button class="btn {{ request()->is('studentlist/manage/three') ? 'active-item':'' }}">Three</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Three</button></h6>
                </div>
