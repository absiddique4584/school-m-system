    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.four') }}"><button class="btn {{ request()->is('studentlist/manage/four') ? 'active-item':'' }}">Four</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Four</button></h6>
                </div>
