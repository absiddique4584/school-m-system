    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.seven') }}"><button class="btn  {{ request()->is('studentlist/manage/seven') ? 'active-item':'' }}">Seven</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Seven</button></h6>
                </div>
