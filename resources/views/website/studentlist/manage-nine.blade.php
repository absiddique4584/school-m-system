    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.nine') }}"><button class="btn  {{ request()->is('studentlist/manage/nine') ? 'active-item':'' }}">Nine</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Nine</button></h6>
                </div>
