    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.eight') }}"><button class="btn {{ request()->is('studentlist/manage/eight') ? 'active-item':'' }}">Eight</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Eight</button></h6>
                </div>
