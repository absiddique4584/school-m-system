    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.five') }}"><button class="btn  {{ request()->is('studentlist/manage/five') ? 'active-item':'' }}">Five</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Five</button></h6>
                </div>
