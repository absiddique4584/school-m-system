...
@section('content')
    <div class="container">
        <div class="row">
            <div class="">
                <div class="">
                    <h5><strong>Click For Other Class Students Information</strong> </h5>
                </div>
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            <a  href="{{ route('studentlist.manage.one') }}"><button class="btn btn-info">One</button></a>
                            ...
                            <a href="{{ route('studentlist.manage.eleven') }}"><button class="btn  {{ request()->is('studentlist/manage/eleven') ? 'active-item':'' }}">Eleven</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Eleven</button></h6>
                </div>
