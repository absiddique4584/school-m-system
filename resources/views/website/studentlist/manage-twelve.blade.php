    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.twelve') }}"><button class="btn  {{ request()->is('studentlist/manage/twelve') ? 'active-item':'' }}">Twelve</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Twelve</button></h6>
                </div>
