    ...
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="container-fluid ">
                    <div class="row">
                        <div>
                            ...
                            <a href="{{ route('studentlist.manage.six') }}"><button class="btn  {{ request()->is('studentlist/manage/six') ? 'active-item':'' }}">Six</button></a>
                ...
                <hr>
                <div class="">
                    <h6>Class >> <button class="btn btn-info">Six</button></h6>
                </div>
